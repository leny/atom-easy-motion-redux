...
class InputView extends View {
    ...
    handleEvents() {
        ...
        this.subscriptions.add( this.oRefTextEditorView.onDidChangeScrollTop( this.goBack.bind( this ) ) );
    }
    ...
    confirm() {
        ...
        if ( this.bSelect || !this.oRefTextEditor.getLastSelection().isEmpty() ) {
    ...
    getColumnRangeForRow( iRow ) {
        ...
        if ( this.oRefTextEditor.isSoftWrapped() ) {
            ...
            let iMaxColumn = this.oRefTextEditor.getEditorWidthInChars(),
                ...
                iLeft = this.oRefTextEditorView.getScrollLeft();
